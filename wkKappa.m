function k=wkKappa(Ypred, Ytrue, classes)
% Slight interface change for non-global variable based coding /WK 2010.
% March
...
[OA, x]=wkCalAcc(Ypred, Ytrue, classes);
...
function k=kcomp(m, f, x, w, alpha)
% global m f x alpha
